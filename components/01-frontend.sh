...
sed -i -e '/catalogue/ s/localhost/catalogue.roboshop.internal/' /etc/nginx/default.d/roboshop.conf -e '/user/ s/localhost/user.roboshop.internal/' /etc/nginx/default.d/roboshop.conf -e '/cart/ s/localhost/cart.roboshop.internal/' /etc/nginx/default.d/roboshop.conf
CheckStatus $?
